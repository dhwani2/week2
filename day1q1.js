//Extend the practice question and make the number of likes changeable by the user.
//Hint: use a function!
//Write out a seperate test function to test different inputs!
...
// filters post with more than 3 likes
let result = allPosts.filter(function(post) {
    return post.likes.length > 3;
});
